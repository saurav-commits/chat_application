...
var DataLoader = function DataLoader(props) {
  ...
  React.useEffect(function () {
    if (!didMountRef.current) {
      ...
      getSession();
      reactChatEngine.getLatestChats(props, 25, function (chats) {
  ...
  function onGetChats(chats) {
    ...
    reactChatEngine.getLatestMessages(props, activeChatID, 45, function (id, list) {
      setSendingMessages({});
...
var Socket = function Socket(props) {
  ...
  var _useState2 = React.useState(Date.now() + minSocketLag),
  ...
  function onConnect(conn) {
    ...
    if (Date.now() > reconnect || conn.renderChatFeed) {
      reactChatEngine.getLatestMessages(conn, activeChat, 45, function (id, list) {
        setSendingMessages({});
  ...
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(DataLoader, props), sessionToken !== '' && /*#__PURE__*/React__default.createElement(nextjsWebsocket.WebSocket, {
    reconnect: true,
...
var SocketChild = function SocketChild(props) {
  ...
  var _useState2 = React.useState(Date.now()),
      now = _useState2[0],
      setNow = _useState2[1];

  var _useState3 = React.useState(Date.now() + minSocketLag$1),
...
var ChatSocket = function ChatSocket(props) {
  ...
  if (hide) {
    ...
    return /*#__PURE__*/React__default.createElement(SocketChild, _extends({}, props, {
      reRender: function reRender() {
        return _reRender();
      }
    }));
...
var NewChatForm = function NewChatForm(props) {
  ...
  }, selected ? /*#__PURE__*/React__default.createElement("form", {
  ...
  }, "My Chats")), /*#__PURE__*/React__default.createElement("div", {
    style: {
      width: '100%',
      textAlign: 'right'
    }
...
var ChatCard$1 = function ChatCard$1(props) {
  ...
  }, title), !didReadLastMessage(chat) && /*#__PURE__*/React__default.createElement("div", {
...
var AuthFail = function AuthFail(props) {
  ...
  }, "Your credentials are incorrect. Make sure your Project ID, Username, and Password are correct ", /*#__PURE__*/React__default.createElement("a", {
    href: "https://chatengine.io/projects/" + project
  }, "here"), "."), /*#__PURE__*/React__default.createElement("img", {
...
var CreateChat = function CreateChat() {
  ...
  }, "Welcome!"), /*#__PURE__*/React__default.createElement("div", {
    id: "ce-ice-breaker-text",
    style: {
      color: '#afafaf'
    }
  }, "Create a new chat to get started."), /*#__PURE__*/React__default.createElement("img", {
...
var IceBreaker = function IceBreaker() {
  ...
  }, "No messages here yet..."), /*#__PURE__*/React__default.createElement("img", {
    id: "ce-ice-breaker-gif",
    style: {
      width: '50%',
      maxWidth: '200px'
...
var ChatListDrawer = function ChatListDrawer(props) {
  ...
  }, /*#__PURE__*/React__default.createElement(ChatList, _extends({}, propsAndContext, {
    onClose: function onClose() {
...
var PersonRow = function PersonRow(props) {
  ...
  }, renderPersonText(person)), selected && conn.userName === chat.admin.username && person.username !== chat.admin.username && /*#__PURE__*/React__default.createElement("div", {
...
var SettingsBlock = function SettingsBlock(props) {
  ...
  }, props.label), /*#__PURE__*/React__default.createElement(icons.LeftOutlined, {
    style: {
      "float": 'right',
      position: 'relative',
      bottom: '30px',
  ...
  })), /*#__PURE__*/React__default.createElement("div", null, !collapsed && props.children));
};
...
var PeopleSettings = function PeopleSettings() {
  ...
  }), renderChatPeople(chat.people, chat), /*#__PURE__*/React__default.createElement("div", {
    style: {
      height: '12px'
    }
  }), conn && chat && conn.userName === chat.admin.username && /*#__PURE__*/React__default.createElement(PersonForm, {
    conn: conn,
    chat: chat
  }))));
};
...
var OptionsSettings = function OptionsSettings() {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    onClick: function onClick() {
      return reactChatEngine.deleteChat(conn, chat.id, function (data) {});
    },
    style: {
      width: '100%',
      marginBottom: '12px'
...
var ChatSettingsTop = function ChatSettingsTop() {
  ...
  }, topPeople.length === 1 && renderOnePerson(topPeople), chat.is_direct_chat && otherPerson && renderOnePerson([otherPerson]), !chat.is_direct_chat && otherPerson && topPeople.length === 2 && renderTwoPeople(topPeople), !chat.is_direct_chat && otherPerson && topPeople.length === 3 && renderThreePeople(topPeople)), chat.is_direct_chat && otherPerson ? /*#__PURE__*/React__default.createElement("div", {
    style: {
      paddingTop: '55px',
      paddingBottom: '7px',
      fontSize: '16px',
...
var ChatSettings = function ChatSettings(props) {
  ...
  }, props.renderChatSettingsTop ? props.renderChatSettingsTop(conn, chat) : /*#__PURE__*/React__default.createElement(ChatSettingsTop, null), props.renderPeopleSettings ? props.renderPeopleSettings(conn, chat) : /*#__PURE__*/React__default.createElement(PeopleSettings, null), props.renderPhotosSettings ? props.renderPhotosSettings(chat) : /*#__PURE__*/React__default.createElement(PhotosSettings, null), conn && chat && conn.userName === chat.admin.username && /*#__PURE__*/React__default.createElement("div", null, props.renderOptionsSettings ? props.renderOptionsSettings(conn, chat) : /*#__PURE__*/React__default.createElement(OptionsSettings, null))));
};
var styles$7 = {
  settingsContainer: {
    height: '100%',
...
var ChatSettingsDrawer = function ChatSettingsDrawer(props) {
  ...
  }, "Chat Settings")), /*#__PURE__*/React__default.createElement(ChatSettings, props)));
};
var styles$8 = {
  drawerContainer: {
    position: 'fixed',
...
var ChatHeader = function ChatHeader() {
  ...
  }, /*#__PURE__*/React__default.createElement(ChatListDrawer, null)), /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
    xs: 8,
    sm: 12,
  ...
  }, title ? title : /*#__PURE__*/React__default.createElement(icons.LoadingOutlined, null)), /*#__PURE__*/React__default.createElement("div", {
    style: styles$9.subtitleText,
    className: "ce-chat-subtitle-text"
  }, text)), /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
    xs: 2,
    sm: 0,
    style: _extends({}, styles$9.mobileOptiom, {
      right: '6px'
  ...
  }, /*#__PURE__*/React__default.createElement(ChatSettingsDrawer, null)));
};
var styles$9 = {
  titleSection: {
    position: 'absolute',
...
var FileView = function FileView(props) {
  ...
  }, /*#__PURE__*/React__default.createElement(icons.FileOutlined, null), ' ', getFileName(attachment.file));
};
var styles$c = {
  loadingContainer: {
    display: 'inline-block',
...
var Message = function Message(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, renderImages()), /*#__PURE__*/React__default.createElement("div", {
    style: {
      display: 'auto'
    },
    className: "ce-my-message-attachments-container ce-my-message-files-container"
  }, renderFiles()), /*#__PURE__*/React__default.createElement(reactGridSystem.Row, {
    style: {
      paddingRight: '2px'
    },
    ...
    sm: 12,
    md: 12
  }, hovered && /*#__PURE__*/React__default.createElement("span", {
    style: {
      position: 'relative',
      top: 'calc(50% - 12px)',
      right: '8px',
  ...
  }, formatTime(getDateTime(message.created, conn !== null && conn.offset))), !attachments || message.text && /*#__PURE__*/React__default.createElement("div", {
...
var TheirMessage = function TheirMessage(props) {
  ...
  }, renderFiles()), !attachments || message.text && /*#__PURE__*/React__default.createElement("div", {
    style: {
      paddingLeft: '48px'
    }
  }, /*#__PURE__*/React__default.createElement("div", {
  ...
  }, formatTime(getDateTime(message.created, conn !== null && conn.offset)))), /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
    xs: 9,
    style: {
      marginLeft: '48px'
    },
...
var SendingMessage = function SendingMessage(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    className: "ce-my-message-attachments-container ce-my-message-images-container"
  }, renderImages(attachments)), /*#__PURE__*/React__default.createElement("div", {
    style: {
      display: 'auto'
    },
    className: "ce-my-message-attachments-container ce-my-message-files-container"
  }, renderFiles(attachments)), /*#__PURE__*/React__default.createElement(reactGridSystem.Row, {
    style: {
      paddingRight: '2px'
    },
  ...
  }, formatTime(getDateTime(message.created, conn !== null && conn.offset))), message.text && /*#__PURE__*/React__default.createElement("div", {
    className: "ce-message-bubble ce-my-message-bubble",
...
var Message$1 = function Message$1(props) {
  ...
  }) : /*#__PURE__*/React__default.createElement("div", null, message.sender_username === conn.userName || message.sender_username === conn.senderUsername ? /*#__PURE__*/React__default.createElement(Message, {
    chat: chat,
    conn: conn,
    lastMessage: lastMessage,
    message: message,
...
var SendingMessages = function SendingMessages(props) {
  ...
  return keys.map(function (key, index) {
    ...
    if (message && message.chat === activeChat) {
      ...
      }, props.renderSendingMessage ? props.renderSendingMessage(conn, chat, sendingMessages[lastMessageKey], message, sendingMessages[nextMessageKey]) : /*#__PURE__*/React__default.createElement(Message$1, {
        sending: true,
        chat: chat,
        message: message,
...
var FilePreview = function FilePreview(props) {
  ...
  }, /*#__PURE__*/React__default.createElement(icons.FileOutlined, null), ' ', props.file && props.file.name, " ", ' ', hovered && /*#__PURE__*/React__default.createElement(icons.CloseCircleTwoTone, {
  ...
  function renderFiles() {
    return props.files.map(function (file, index) {
      if (!isImage$1(file.name)) {
        return /*#__PURE__*/React__default.createElement(FilePreview, {
          file: file,
          key: "thumb_" + index,
...
var Thumbnail$2 = function Thumbnail(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    src: blob
  }), hovered && /*#__PURE__*/React__default.createElement(icons.CloseCircleTwoTone, {
...
var SendButton = function SendButton() {
  ...
  }, /*#__PURE__*/React__default.createElement(icons.ArrowUpOutlined, {
    style: {
      color: 'white'
    }
  })));
...
var NewMessageForm$1 = function NewMessageForm() {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, /*#__PURE__*/React__default.createElement(ImagesRow, {
    files: attachments,
    onRemove: function onRemove(i) {
      return _onRemove(i);
    }
  }), /*#__PURE__*/React__default.createElement(FilesRow, {
    files: attachments,
    onRemove: function onRemove(i) {
      return _onRemove(i);
    }
  }), /*#__PURE__*/React__default.createElement(ReactQuill, {
    theme: "snow",
    value: value,
    modules: modules,
    formats: formats,
    ...
    className: "ql-link"
  }), /*#__PURE__*/React__default.createElement(AttachmentsInput, {
  ...
  }, /*#__PURE__*/React__default.createElement(SendButton, null))));
};
var styles$k = {
...
var ConnectionBar = function ConnectionBar(props) {
  ...
  if (!connecting || !isVisible) return /*#__PURE__*/React__default.createElement("div", null);
  return /*#__PURE__*/React__default.createElement("div", {
    style: {
      zIndex: '1',
      bottom: '66px',
...
var ScrollDownBar = function ScrollDownBar(props) {
  ...
  var chat = props.chat;
  if (conn === null || !chat || chat === null) return /*#__PURE__*/React__default.createElement("div", null);
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    onClick: function onClick() {
      return reactScroll.animateScroll.scrollToBottom({
        duration: 333,
        containerId: "ce-feed-container"
      });
    }
  }, /*#__PURE__*/React__default.createElement(icons.CaretDownOutlined, null), conn.userName ? ' Unread Messages' : ' Scroll to Bottom');
};
...
var ChatFeed = function ChatFeed(props) {
  ...
  function loadMessages(loadMoreMessages) {
    if (loadMoreMessages) {
      ...
      reactChatEngine.getLatestMessages(conn, activeChat, count, function (chatId, messages) {
      ...
      reactChatEngine.getLatestMessages(conn, props.activeChat, count, function (chatId, messages) {
        return onGetMessages(chatId, messages, "ce-feed-container");
      });
    }
  }
  ...
  }, props.renderChatHeader ? props.renderChatHeader(chat) : /*#__PURE__*/React__default.createElement(ChatHeader, null), /*#__PURE__*/React__default.createElement("div", {
  ...
  }), Object.keys(messages).length > 0 && /*#__PURE__*/React__default.createElement(RenderTrigger, {
    onEnter: function onEnter() {
      return setLoadMoreMessages(true);
    }
  }), needsIceBreaker && props.renderIceBreaker && props.renderIceBreaker(chat), needsIceBreaker && !props.renderIceBreaker && /*#__PURE__*/React__default.createElement(IceBreaker, null), /*#__PURE__*/React__default.createElement(Messages, props), /*#__PURE__*/React__default.createElement(SendingMessages, props), props.renderIsTyping ? props.renderIsTyping(typers) : /*#__PURE__*/React__default.createElement(IsTyping, null), props.renderConnectionBar ? props.renderConnectionBar(chat) : /*#__PURE__*/React__default.createElement(ConnectionBar, {
    renderDelay: 3000
  }), props.renderScrollDownBar ? props.renderScrollDownBar(chat) : /*#__PURE__*/React__default.createElement(ScrollDownBar, {
    chat: chat
  }), /*#__PURE__*/React__default.createElement("div", {
    style: {
      height: '86px'
  ...
  })), props.renderNewMessageForm ? props.renderNewMessageForm(props, currentChat) : /*#__PURE__*/React__default.createElement(NewMessageForm$1, null));
};
var styles$l = {
  feedContainer: {
    width: '100%',
...
var ChatEngine = function ChatEngine(props) {
  ...
  }, /*#__PURE__*/React__default.createElement(Socket$1, props), /*#__PURE__*/React__default.createElement(reactGridSystem.Row, null, /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
    xs: 0,
    sm: 3,
    style: {
      height: height ? height : ''
    }
  }, props.renderChatList ? props.renderChatList(propsAndContext) : /*#__PURE__*/React__default.createElement(ChatList, _extends({}, propsAndContext, {
    onChatClick: function onChatClick(chatID) {
      if (props.renderChatFeed) {
        reactChatEngine.getLatestMessages(props, chatID, 45, function (id, list) {
  ...
  }, props.renderChatFeed ? props.renderChatFeed(propsAndContext) : /*#__PURE__*/React__default.createElement(ChatFeed, propsAndContext)), /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
    xs: 0,
    sm: 3,
    style: {
      height: height ? height : ''
    }
  }, props.renderChatSettings ? props.renderChatSettings(props) : /*#__PURE__*/React__default.createElement(ChatSettings, props))));
};

var ChatEngineApp = function ChatEngineApp(props) {
  if (React.useContext(ChatEngineContext)) {
    return /*#__PURE__*/React__default.createElement(ChatEngine, props);
  } else {
    return /*#__PURE__*/React__default.createElement(ChatEngineWrapper, null, /*#__PURE__*/React__default.createElement(ChatEngine, props));
  }
};
...
exports.ChatCard = ChatCard$1;
exports.ChatEngine = ChatEngineApp;
exports.ChatEngineContext = ChatEngineContext;
exports.ChatEngineWrapper = ChatEngineWrapper;
...
exports.PeopleSettings = PeopleSettings;
exports.PhotosSettings = PhotosSettings;
exports.ScrollDownBar = ScrollDownBar;
...
exports.getChatsBefore = getChatsBefore;
exports.getLatestChats = getLatestChats;
